                    ...
                    <table className="table-auto w-full border-collapse">
                        <thead className="bg-gray-200 text-gray-700">
                            <tr>
                                ...
                                <th className="border px-4 py-2 text-left text-sm hidden md:table-cell">
                                    Fecha de Emisión
                                </th>
                                <th className="border px-4 py-2 text-left text-sm">Observaciones</th>
                                <th className="border px-4 py-2 text-left text-sm hidden lg:table-cell">
                                    Quién Reportó
                                </th>
                                <th className="border px-4 py-2 text-left text-sm hidden lg:table-cell">
                                    Quién le dio Seguimiento
                                </th>
                                <th className="border px-4 py-2 text-left text-sm hidden md:table-cell">
                                    Días Transcurridos
                                </th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="border px-4 py-2 text-left text-sm hidden md:table-cell">
                                    2024-01-10
                                </td>
                                <td className="border px-4 py-2 text-left text-sm">Falla en el proyector</td>
                                <td className="border px-4 py-2 text-left text-sm hidden lg:table-cell">
                                    Juan Pérez
                                </td>
                                <td className="border px-4 py-2 text-left text-sm hidden lg:table-cell">
                                    María López
